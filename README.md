...
+ 1. [Census Data](https://www.census.gov/programs-surveys/popest/data.html)
...
The idea is to build a system that models *population characteristics* across geography and time.
